...
from .models import Düzensiz,Düzensizm,Düzensize,Düzensizkategori, Harcayan, Düzenlikategori
from .models import Kategorisi,Gıdakategorisi,Sahibi,Kartlar,Gelir,Günlük,Haftalık,Hedefler,Birim
...
class GelirAdmin(admin.ModelAdmin):
    list_display = ('sahibi', 'birim', 'miktar', 'tarih')  # Listeleme sırasında hangi alanların görüneceğini belirler
    list_filter = ('sahibi__başlık','birim','tarih',) # Filtreleme seçenekleri ekler  
...
class ÖdemedetayAdmin(admin.ModelAdmin):
    list_display = ('üstkategorisi', 'kaçıncı_taksit', 'tutar', 'ödemeson', 'ödendimi', 'tutar')  # Listeleme sırasında hangi alanların görüneceğini belirler
    list_filter = ('üstkategorisi','ödemeson','ödendimi',) # Filtreleme seçenekleri ekler
admin.site.register(Ödemedetay, ÖdemedetayAdmin)

class GıdaAdmin(admin.ModelAdmin):
    list_display = ('harcayan', 'başlık', 'birim', 'miktar', 'tutar', 'tarih')  # Listeleme sırasında hangi alanların görüneceğini belirler
    list_filter = ('harcayan__başlık','başlık','tarih',) # Filtreleme seçenekleri ekler
...
admin.site.register(Düzenlikategori)
